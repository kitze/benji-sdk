...
export class TodoViews {
     ...
     * List waiting todos
     *
     * List todos marked as waiting for the current user.
     */
    public static todoViewsWaiting<ThrowOnError extends boolean = false>(options?: Options<TodoViewsWaitingData, ThrowOnError>) {
        return (options?.client ?? client).post<TodoViewsWaitingResponses, TodoViewsWaitingErrors, ThrowOnError>({
            security: [{ name: 'x-api-key', type: 'apiKey' }],
     ...
     * List blocked todos
     *
     * List todos that are blocked by other todos (dependency chain).
     */
    public static todoViewsBlocked<ThrowOnError extends boolean = false>(options?: Options<TodoViewsBlockedData, ThrowOnError>) {
        return (options?.client ?? client).post<TodoViewsBlockedResponses, TodoViewsBlockedErrors, ThrowOnError>({
            security: [{ name: 'x-api-key', type: 'apiKey' }],
